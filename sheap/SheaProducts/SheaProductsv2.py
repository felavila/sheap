...
from sheap.SheaProducts.Utils.extrac_basic_params_sampled import extract_basic_params_sampled
from sheap.SheaProducts.Utils.extrac_basic_params import extract_basic_params_single
...
class SheaProducts:
    ...
    def __init__(self,*,samplerclass: Optional[object] = None,model=None,dependencies=None,spectra=None,mask=None,sheapmodel=None,method=None,d=None,
        ...
        **extra,):
        ...
        self.MC = MasterCombineProfile(LINES_TO_COMBINE= self.LINES_TO_COMBINE,limit_velocity=self.limit_velocity
                                       ,C_KMS=self.C_KMS,full_cont_profile=self.full_cont_profile,ucont_params = None,full_cont_profile_NONE = self.full_cont_profile_NONE)
    ...
    def calculate_sheap_products_sampled(self,idx,samples,combine=True,extra_products=True):
    ...
    def calculate_sheap_products(self,combine=True,extra_products=True):
        params = self.sheapmodel.params
        uncertainty_params = self.sheapmodel.uncertainty_params
        ...
        products = extract_basic_params_single(self.spectra,self.mask,params,uncertainty_params,continuum_idx_all=self.full_cont_idx,
