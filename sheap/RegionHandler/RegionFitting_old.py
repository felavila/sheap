...
#         self.fe_upper_width = fe_upper_width  # Maximum width for outflow emission lines
#         self.fe_lower_width = fe_lower_width  # Minimum width for outflow emission lines (sigma)
...
#         self.fe_center_shift_limit = fe_center_shift_limit
...
#             if not line.get("center"):
#                 line.update({"center":0.0})
#             local_pararameters = []
...
#             elif profile=="fitFeOP":
#                 line["profile"] = "fitFeOP"
...
#         fe_center_shift_limit = kwargs.get("fe_center_shift_limit",self.fe_center_shift_limit)
#         fe_upper_width = kwargs.get("fe_upper_width",self.fe_upper_width)
#         fe_lower_width = kwargs.get("fe_lower_width",self.fe_lower_width)
...
#             if how.lower()=="template":
#                 if which== "OP":
#                     profile = "fitFeOP"
#                     initial_params = [jnp.log10(1100), 2., 5] 
#                     upper_bound = [3.5,100,100]
#                     lower_bound = [3.001,-100,0]
#                     params = ["log_FWHM_broad","shift","scale"]
#                 elif which== "UV":
#                     print("This is not tested jet")
#                     profile = "fitFeUV"
#                     initial_params = [jnp.log10(1100), 2., 5] 
#                     upper_bound = [3.5,100,100]
#                     lower_bound = [3.001,-100,0]
#                     params = ["log_FWHM_broad","shift","scale"]
#                 else:
#                     print("Only UV or OP at the moment")
#                 return initial_params,upper_bound,lower_bound,profile,params   
#             elif how=="sum":
#                 center = center
#                 profile = profile
#                 center_upper = center + kms_to_wl(fe_center_shift_limit, center)
...
#         else:
#             print(f"this {kind} dosent have its own deffinition")
...
# # if len(fit_Fe)>0:
# # def template_fe_handler(fit_Fe,profile_function_list,profile_list,profile_index_list,params_dict):
# #      for i in fit_Fe:
# #         how = i.get("how")
# #         wich = i.template("which")
# #         if how=="template":
# #             if wich=="OP":    
# #                 profile_function_list.append(fitFeOP)     
