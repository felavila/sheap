...
# This module provides :class:`SingleSampler`, a lightweight interface for
# extracting physical quantities directly from best–fit parameters (without
# posterior sampling).

# Main Features
# -------------
# - Groups parameters by spectral region and line profile.
# - Computes basic line quantities:
#   * flux
#   * FWHM and velocity widths
#   * line centers and amplitudes
#   * equivalent widths (EQW)
#   * luminosities (line and monochromatic)
# - Combines narrow and broad components for selected lines
#   (e.g., Hα, Hβ) when possible.
# - Computes bolometric luminosities and applies single–epoch
#   black hole mass estimators.
# - Supports uncertainty propagation using :mod:`auto_uncertainties`.

# Public API
# ----------
# - :class:`SingleSampler`
#     * :meth:`SingleSampler.extract_basic_line_parameters` —
#       compute line-by-line quantities from best–fit parameters.
#     * :meth:`SingleSampler.posterior_physical_parameters` —
#       assemble line quantities, combined components, bolometric
#       corrections, and derived estimators into a structured dictionary.

# Notes
# -----
# - Designed for “single” mode (deterministic optimization results),
#   as opposed to Monte Carlo or MCMC posterior samplers.
# - Uses helper functions from
#   :mod:`sheap.ComplexAfterFit.Samplers.utils` for profile integration,
#   continuum evaluation, and profile combination.
# """
