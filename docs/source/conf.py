...
while i < len(body_lines):
    ...
    if (not first_replaced
        ...
        new_title = "Welcome to sheap’s documentation\n"
...
#hdr = "Welcome to sheap’s documentation\n" + "=" * len("Welcome to sheap’s documentation") + "\n\n"

with open("getting_startedxd.rst", "wt") as f:
    #f.write(hdr)
...
with open("../../tutorials/index.rst", "rt") as f1:
