...
Report bugs at [https://github.com/favila/sheap/issues](https://github.com/favila/sheap/issues).
W
Stambling upon a Bug means encountering different behaviour than the expected/advertised one. When you are reporting a bug, please include the following infromation by filling in [the template](https://github.com/favila/sheap/.github/blob/master/.github/ISSUE_TEMPLATE/bug_report.md).
...
The best way to send feedback is to file an issue at [https://github.com/favila/sheap/issues](https://github.com/favila/sheap/issues).
...
Here's how to set up `sheap` for local development.

1. Fork the `sheap` repo on GitHub.
...
The roadmap located [here](https://github.com/favila/sheap/milestones?direction=desc&sort=due_date&state=open)
